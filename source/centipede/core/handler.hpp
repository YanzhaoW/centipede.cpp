...
namespace centipede
{
    ...
    class Handler
    {
      public:
        ...
        [[nodiscard]] auto get_engine() const -> const auto& { return engine_; }
        ...
        [[nodiscard]] auto get_current_engine() const -> const auto& { return engine_.get_engine(); }
